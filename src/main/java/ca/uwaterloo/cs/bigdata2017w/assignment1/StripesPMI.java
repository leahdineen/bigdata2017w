...
public class StripesPMI extends Configured implements Tool {
  ...
  private static final class StripesMapper extends Mapper<LongWritable, Text, PairOfStrings, FloatWritable> {
  ...
  public int run(String[] argv) throws Exception {
    ...
    stripesJob.setJobName(StripesPMI.class.getSimpleName() + "StripesPMIComputation");
    ...
    stripesJob.setMapOutputKeyClass(PairOfStrings.class);
    stripesJob.setMapOutputValueClass(FloatWritable.class);
    stripesJob.setOutputKeyClass(PairOfStrings.class);
    stripesJob.setOutputValueClass(PairOfFloatInt.class);
